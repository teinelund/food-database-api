package org.teinelund.fooddatabaseapi;
    ...
    public void execute(String[] args, JCommander jc) {
        if (help || version) {
            if (help) {
                ...
                System.out.println("Food Database Api. Version: " + versionString);
        ...
        System.out.println("Welcome to food-database-api!");
    }
